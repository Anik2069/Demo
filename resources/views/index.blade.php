                    ...
                    <div class="row ">
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                        <div class="card-content">
                          <h5 class="font-15">Total Group</h5>
                ...
                <div class="card-statistic-4">
                  <div class="align-items-center justify-content-between">
                    <div class="row ">
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                        <div class="card-content">
                          <h5 class="font-15">Total Medicine</h5>
                            ...
                            <table class="table table-striped" id="table-1">
                                ...
                                @foreach($value1 as $val)
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$val['stock']}} Box</td>
@if($val['stock']<=0)
    <td><button class="btn btn-danger" disabled>Out Of Stock</button></td>
    @else
                                            <td><button class="btn btn-danger" disabled> Stock Limited</button></td>
