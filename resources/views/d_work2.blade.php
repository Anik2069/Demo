                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-12 col-lg-12">
                            ...
                            <div class="card">
                                ...
                                <form action="/submitbuyingproduct" method="post">
                                    @csrf
                                    <div class="card-body">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-2">
                                                <label for="inputZip">Buying Amount</label>
                                            ...
                                            <div class="form-group col-md-2">
                                                ...
                                                <select class="form-control" name="unit">
                                                    ...
                                                    <option name="Pata">Pata</option>
                                                </select>
                                            </div>
                                            <div class="form-group col-md-2">
                                                <label for="inputZip">Mfg Date</label>
                                        ...
                                        <table class="table table-striped" id="table-1">
                                            ...
                                            @foreach($value as $val)
                                                <tr>
                                                    ...
                                                    <td>{{$val['buyingamount']}} {{$val['unit']}}</td>
                                                    <td>{{$val['buying']}} Tk</td>
                                                    <td>{{$val['buying']*$val['buyingamount']}} TK</td>
                                                    <td><a href="/deletedproduct/{{$val['id']}}" class="btn btn-danger">Delete</a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                            {{--  <tr>
