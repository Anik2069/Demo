                        ...
                        @foreach($value as $val)
                          <tr>
                            ...
                            <td>{{ $val['product_name'] }}</td>
                              ...
                              <td>{{ $val['buying'] }} Tk</td>
                              <td>{{ $val['buyingamount'] *$val['buying']}} Tk</td>
                            <td>
                                <a href="dltb/{{$val['id']}}" class="btn btn-icon btn-danger" onclick="return confirm('Do you want to delete this Record???')"><i class="fas fa-trash-alt"></i></a>
                            </td>
