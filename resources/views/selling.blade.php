                        ...
                        @foreach($value as $val)
                          <tr>
                            ...
                            <td>{{ $val['product_name'] }}</td>
                              <td>{{ $val['selling'] }} {{ $val['unit']}}</td>
                              <td>{{ $val['unitprice'] }} Tk</td>
                              <td>{{ $val['unitprice'] *$val['selling']}} Tk</td>
                            <td>
                                <a href="dlts/{{$val['id']}}" class="btn btn-icon btn-danger" onclick="return confirm('Do you want to delete this Record???')"><i class="fas fa-trash-alt"></i></a>
                            </td>
