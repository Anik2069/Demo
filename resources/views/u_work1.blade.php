                    ...
                    <table class="table table-striped">
                     ...
                     @foreach($value1 as $val)
                       <tr>
                         ...
                         <td>{{(double)$val['price']-((double)$val['return']*(double)$val['unit'])}} BDT</td>
                       </tr>
@endforeach
                    ...
                    <div class="table-responsive">
                      <table class="table table-bordered table-md">
                        ...
                        <tr>
                          <td>#</td>
                          <td> <b>Total Pay</b> </td>
                          <td> <b>{{$total2}} BDT</b> </td>
                          <td></td>
                        </tr>
                        <tr>
                          <td>#</td>
                          <td> <b>Due</b> </td>
                            <td> <p style="color:red"> <b>{{$total-$total2}} BDT</b> </p> </td>
                          <td></td>
                        </tr>
                      </table>
                    </div>
                            ...
                            <div class="card-body">
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        <label for="inputZip">Comment of the Day</label>
                                        <textarea class="form-control" name="comment">{{$fn}}</textarea>
                                    </div>
                                </div>
                            </div>
