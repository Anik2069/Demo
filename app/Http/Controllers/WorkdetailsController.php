...
class WorkdetailsController extends Controller
{
    ...
    public function deleteinfo($id)
    {
        ...
        $nn = stock::find($ss);
        if($name['unit']=="Pata"){
            $nn->stock = abs($nn['stock']) - $name['buyingamount']/$ss1;

        }
        else{
            $nn->stock = abs($nn['stock']) - $name['buyingamount'];
        }
        $nn->save();
    ...
    public function returnlist1($id)
    {
        ...
        return view('u_work1', compact('value1', 'c', 'total', 'value2', 'd','value3','e','total2','total1','fn'));
